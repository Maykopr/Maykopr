...
* **Automação e Integrações:** Desenvolvimento de scripts e aplicações (APIs, webhooks) para otimizar fluxos operacionais e ferramentas/sistemas em geral.
* **Projetos Open Source & Acadêmicos:** Entusiasta de arquitetura de software, padrões de projetos e engenharia de software aplicada a problemas reais.
* **Colaboração Profissional:** Aberto a conexões com profissionais da área para trocar experiências sobre DevOps, observabilidade, automação, e redes/sistemas.

---

## 📫 Vamos nos conectar?
[![Outlook](https://img.shields.io/badge/Microsoft_Outlook-0078D4?style=for-the-badge&logo=microsoft-outlook&logoColor=white)](mailto:maykopr@hotmail.com)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/mayko-costa/)
